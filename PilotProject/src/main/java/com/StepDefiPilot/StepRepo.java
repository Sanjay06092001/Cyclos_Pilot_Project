...
@FindBy (xpath="(//div[@class='custom-menus']//a)[2]")//Login Button
...
@FindBy (xpath="//button[contains(@class,'btn d-flex')]")//Submit button
public static WebElement submit1;
@FindBy (xpath="//a[contains(text(),'Prajwal')]")//click profile
public static WebElement profile;
@FindBy (xpath="//button[@type='button']//div[1]")//click edit
