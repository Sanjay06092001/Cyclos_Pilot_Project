...
public  class Messageclass{
	...
	@FindBy(xpath ="//*[@id=\"id_10\"]")//clicking subject
	public static WebElement subject;
	@FindBy(xpath="//SELECT[@id=\"id_154_fontname\"]")//clicking font
	public static WebElement font;
	@FindBy(xpath="(//button[@class=\"btn btn-icon\"])[4]")//clicking style
	public static WebElement style;
	@FindBy(css="div[class=\"editor\"]")//content
	public static WebElement content;
	@FindBy(xpath="//button[@class=\"btn d-flex justify-content-center align-items-center w-100 h-100 btn-primary\"]")//send
