...
public void congif() {
	...
	PageFactory.initElements(driver,Messageclass1.class);
...
public void i_click_on_the_button(String string) throws InterruptedException {
	Thread.sleep(3000);
	Messageclass1.msg.click();
	Thread.sleep(3000);
	Messageclass1.newMessage.click();
}

@When("select a user from the contact list")
public void select_a_user_from_the_contact_list() {
	
	Messageclass1.sendto.click();
	Messageclass1.user.click();
...
public void we_have_enter_the_subject(String string) throws InterruptedException {
	Thread.sleep(3000);
  Messageclass1.contact.click();
  Messageclass1.element.click();
}
